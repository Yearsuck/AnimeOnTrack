...
export const es = {
  ...
  "settings.siteHeading": "Sitio y espejos",
  "settings.importHeading": "Traer mi biblioteca a este sitio",
  "settings.importHelp": "Busca en el sitio activo todas tus series seguidas que aún no están aquí, las enlaza y recupera tu progreso visto. Va poco a poco (una serie cada ~2s) para no saturar el sitio. Útil al cambiar de web.",
  "settings.importButton": "Traer mi biblioteca",
  "settings.importing": "Trayendo…",
  ...
  "settings.backupSetupSteps": "Crea un cliente OAuth de tipo «Aplicación de escritorio» en Google Cloud Console (APIs y servicios → Credenciales), habilita la API de Google Drive y pega aquí sus dos valores. Se guardan solo en este equipo.",
  "settings.backupClientId": "ID de cliente",
  "settings.backupClientSecret": "Secreto de cliente",
  "settings.backupSaveCredentials": "Guardar credenciales",
